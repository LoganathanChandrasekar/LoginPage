...
const Navbar = () => {
  ...
  return (
    <div className='w-full flex justify-between item-center p-4 sm:p-6 sm:px-24 absolute top-0 left-0 z-10'>
      <img src={assets.logo} alt="" className='w-28 sm:w-32'/>
      {userData?
      <div className='w-8 h-8 justify-center item-center rounded-full bg-black text-white relative group'>
